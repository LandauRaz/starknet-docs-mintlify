...
<Warning>
  Currently, block builtin limits apply only for Sepolia. For more information, see [the release notes for Starknet version 0.13.6](/references/version-notes/#starknet_v0_13_6_8_jul_25).
</Warning>
...
| Name                                        | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cairo 0                                     | [Starknet v0.11.0](/references/version-notes/#version0.11.0) introduces Cairo 1.0 smart contracts.                                                                                                                                                                                                                                                                                                                                                                  |
...
| `invoke` transaction v0  | `invoke` transaction v0 has been removed since [Starknet v0.11.0](/references/version-notes/#version0.11.0).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `declare` transaction v0 | `declare` transaction v0 has been removed since [Starknet v0.11.0](/references/version-notes/#version0.11.0).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `deploy` transaction     | The `deploy` transaction has been removed since [Starknet v0.10.3](/references/version-notes/#version0.10.3).<br/><br/>To deploy new contract instances, you can use the [`deploy` system call](https://book.cairo-lang.org/appendix-08-system-calls.html#deploy).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
