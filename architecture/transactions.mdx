...
* [Transaction fields and hash calculations reference](/resources/transactions-reference/) in *Resources*
...
5. **Proof generation and verification:** The prover uses the [Starknet operating system](/architecture/os/) to computes the proof for the correct execution of all transactions in the block, and transmits it to the L1 verifier, which verifies it. At this point, the L1 state is updated to include the transaction.
