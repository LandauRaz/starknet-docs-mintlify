...
To invoke onchain contracts, use [Starknet Foundry's `sncast`](https://foundry-rs.github.io/starknet-foundry/starknet/sncast-overview.html), [Starkli](/tools/overview/), or a [block explorer](/ecosystem/overview/). To get the onchain addresses of the staking and STRK contracts, see [Important addresses](/resources/chain-info/#staking).
