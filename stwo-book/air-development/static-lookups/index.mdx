...
This proves useful especially in proof systems like Stwo that uses finite fields because it allows checking for underflow and overflow.
...
<Frame caption="Figure 1: Range-check lookup">
  <img src="/stwo-book/air-development/static-lookups/range-check.png" />
</Frame>
...
<Frame caption="Figure 2: Finalizing each LogUp column">
  <img src="/stwo-book/air-development/static-lookups/finalize-col.png" />
</Frame>
