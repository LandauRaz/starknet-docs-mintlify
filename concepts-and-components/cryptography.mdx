...
There are three hash functions used throughout Starknet's specifications that map inputs to elements in the [STARK field](/concepts-and-components/cryptography#the-stark-field).
