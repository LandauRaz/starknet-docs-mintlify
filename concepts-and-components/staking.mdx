...
<Warning>
  The Starknet Improvement Proposal (SNIP) for Bitcoin staking on Starknet is now live on the [Starknet community forum](https://community.starknet.io/t/snip-31-bitcoin-staking-on-starknet/115696) and [Sepolia testnet](/resources-and-references/chain-info/#sepolia_4)!
...
*In the upcoming version's contracts, [already deployed on Sepolia](/resources-and-references/chain-info/#sepolia_4), $$C$$ will be 4%.
