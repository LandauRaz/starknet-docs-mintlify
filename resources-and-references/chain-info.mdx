...
| Max L2 gas per block                 | The maximum amount of L2 gas that a block can contain <Note>This limit ensures block production times remains consistent and predictable.</Note> | Mainnet: 5 \* 10<sup>9</sup><br/>Sepolia: 4 \* 10<sup>9</sup> on |
| Max L2 gas per transaction           | The maximum number of computational steps, measured in L2 gas, that a transaction can contain when processed on the Starknet network <Note>This limit is important for ensuring the efficient execution of transactions and preventing potential congestion.</Note> | 10<sup>9</sup>                                   |
| Max state updates per transaction    | The maximum number of storage updates that a single transaction can generate<Note>This limit helps maintain network stability and predictable performance.</Note>                                                                                                 | 2,000                                 |
...
| Max L2 gas for `validate`            | The maximum number of computational steps, measured in Cairo steps, for a `validate` function                                                                                                                                                                   | 10<sup>8</sup>                       |
...
| Max contract class size              | The maximum size for the Sierra file of a contract class within Starknet<Note>This limit is important for ensuring the network's scalability and security.</Note>                                                                                                 | 4,089,446 bytes                       |
...
<Warning>
  Currently, block builtin limits apply only for Sepolia. For more information, see [the release notes for Starknet version 0.13.6](/resources-and-references/version-notes/#starknet_v0_13_6_8_jul_25).
</Warning>
...
| Name                                        | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cairo 0                                     | [Starknet v0.11.0](/resources-and-references/version-notes/#version0.11.0) introduces Cairo 1.0 smart contracts.                                                                                                                                                                                                                                                                                                                                                                  |
| Transaction signing only over two resources | RPC version 0.8, introduced in Starknet 0.13.5, only supports `v3` transactions that sign over three resources (L1 gas, L2 gas and L1 data gas), removing support for transaction versions `v0`, `v1`, and `v2`, and for `v3` transactions that sign only over two resources (L1 gas and L2 gas).Starting from version v0.14.0, Starknet will stop accepting these transactions altogether, and will only accept `v3` transactions compliant with RPC 0.8. |
...
| Name                     | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Starknet CLI             | Support for the Starknet CLI has been removed. Instead use [Starkli or Starknet Foundry's `sncast`](/ecosystem/tools/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Goerli testnet           | Goerli testnet support was removed April 2, 2024. Sepolia testnet replaces Goerli testnet.<br/><br/>Starknet started migrating to Sepolia testnet on November 15th, 2023. For more information on the Goerli deprecation, see [the deprecation announcement on Ethereum's site](https://ethereum.org/nb/developers/docs/networks/#ethereum-testnets).<br/><br/>Full nodes, API services, SDKs, and other Starknet developer tools have migrated to Sepolia as well.<Note>Sepolia's state and history are relatively small. Sepolia supports declaring classes of CairoZero and Cairo v2.0.0 and higher.</Note>                                                                                                                                                                                                                                                                                                                                             |
| Starknet feeder gateway  | The Starknet feeder gateway, a temporary solution for querying the sequencer's state, is being replaced by Starknet full nodes (Pathfinder, Juno, Deoxys, Papyrus) and RPC services. For more information, see [Full nodes and API services](/ecosystem/integrations/).Support for the feeder gateway queries that are not required for full nodes to synchronize on the state of Starknet will stop according to the following schedule:<table>  <thead>    <tr>      <th>Environment</th>      <th>Date</th>    </tr>  </thead>  <tbody>    <tr>      <td>Integration</td>      <td>1 November 2023</td>    </tr>    <tr>      <td>Testnet</td>      <td>15 November 2023</td>    </tr>    <tr>      <td>Mainnet</td>      <td>19 December 2023</td>    </tr>  </tbody></table>Queries that are required for full nodes to synchronize on the state of Starknet are still supported.<br/><br/>For more information, see the Community Forum post [*Feeder Gateway Deprecation*](https://community.starknet.io/t/feeder-gateway-deprecation/100233). |
| Free L1→ L2 messaging    | Previously, sending a message from L1 to L2 had an optional fee associated.<br/><br/>From [Starknet v0.11.0](/resources-and-references/version-notes/#version0.11.0), the fee mechanism is enforced and the ability to send L1→L2 messages without the corresponding L2 fee has been removed.<br/><br/>See [here](/concepts-and-components/messaging/#l1-l2-message-fees) for more details.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `invoke` transaction v0  | `invoke` transaction v0 has been removed since [Starknet v0.11.0](/resources-and-references/version-notes/#version0.11.0).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `declare` transaction v0 | `declare` transaction v0 has been removed since [Starknet v0.11.0](/resources-and-references/version-notes/#version0.11.0).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `deploy` transaction     | The `deploy` transaction has been removed since [Starknet v0.10.3](/resources-and-references/version-notes/#version0.10.3).<br/><br/>To deploy new contract instances, you can use the [`deploy` system call](https://book.cairo-lang.org/appendix-08-system-calls.html#deploy).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
