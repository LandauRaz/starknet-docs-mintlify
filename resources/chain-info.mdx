...
<Warning>
  Currently, block builtin limits apply only for Sepolia. For more information, see [the release notes for Starknet version 0.13.6](/resources/version-notes/#starknet_v0_13_6_8_jul_25).
</Warning>
...
| Name                                        | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cairo 0                                     | [Starknet v0.11.0](/resources/version-notes/#version0.11.0) introduces Cairo 1.0 smart contracts.                                                                                                                                                                                                                                                                                                                                                                  |
...
| Free L1→ L2 messaging    | Previously, sending a message from L1 to L2 had an optional fee associated.<br/><br/>From [Starknet v0.11.0](/resources/version-notes/#version0.11.0), the fee mechanism is enforced and the ability to send L1→L2 messages without the corresponding L2 fee has been removed.<br/><br/>See [here](/architecture/messaging/#l1-l2-message-fees) for more details.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `invoke` transaction v0  | `invoke` transaction v0 has been removed since [Starknet v0.11.0](/resources/version-notes/#version0.11.0).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `declare` transaction v0 | `declare` transaction v0 has been removed since [Starknet v0.11.0](/resources/version-notes/#version0.11.0).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `deploy` transaction     | The `deploy` transaction has been removed since [Starknet v0.10.3](/resources/version-notes/#version0.10.3).<br/><br/>To deploy new contract instances, you can use the [`deploy` system call](https://book.cairo-lang.org/appendix-08-system-calls.html#deploy).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
