...
* Understand how to [manage your participitation](/concepts-and-components/staking#procedures) in the staking protocol

* Review [Starknet's roadmap](/concepts-and-components/staking#roadmap) for the staking protocol

* Deep dive into the staking protocol's [specifications](/concepts-and-components/staking#protocol) and [architecture](/concepts-and-components/staking#architecture)
