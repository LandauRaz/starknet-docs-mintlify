...
<Tip>
The steps in this installment are demonstrated on Sepolia.For the equivalent addresses on Mainnet, see [Chain information](/resources-and-references/chain-info#important-addresses).
</Tip>
...
<Note>
To understand the role of the staking address, read more about [validator addresses in the staking protocol](/concepts-and-components/staking#addresses).
</Note>
...
<Note>
The number of STRK tokens to stake must be greater than or equal to [the minimum stake for validators](/concepts-and-components/staking#protocol).
</Note>
...
<Note>
To understand the role of the rewards and operational addresses, read more about [validator addresses in the staking protocol](/concepts-and-components/staking#addresses).
